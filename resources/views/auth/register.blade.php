...
<head>
    ...
    <title>Daftar - Bergabunglah dengan Kami</title>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="glass-effect rounded-3xl shadow-2xl p-8 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-3xl font-bold gradient-text mb-2">Bergabunglah!</h1>
                    <p class="text-white/80 font-medium">Daftar Sekarang dan Mulai Berbelanja di Elysian Home!</p>
                </div>

                <!-- Register Form -->
                <form method="POST" id="formRegister" action="/register" class="space-y-6">
                    @csrf

                    <!-- Name Field -->
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i class="fas fa-user text-white/60 group-focus-within:text-blue-400 transition-colors duration-200"></i>
                        </div>
                        <input
                            type="text"
                            name="name"
                ...
                <div class="text-center mt-6">
                    <p class="text-white/80">
                        Sudah punya akun?
                        <a href="/login" class="text-blue-300 hover:text-blue-200 font-semibold transition-colors duration-200 hover:underline">
                            Login di sini
                        </a>
                    </p>
                </div>
        ...
        function simpan() {
            if (name.value === '') {
                ...
                Swal.fire({
                        icon: 'error',
                        title: 'Data Kosong!',
                        text: 'Input Konfirmasi Password Harus Di Isi!',
                    });
