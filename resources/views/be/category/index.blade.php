...
@section('categorypage')
    ...
    <div class="d-flex flex-column justify-content-between align-items-start mb-5">
        <h1 class="fs-3 fw-bold text-dark">Table Category Overview</h1>
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow">
            <div class="card-header py-3 border-bottom">
                <h3 class="fs-5 fw-medium">Dashboard Data Category</h3>
            </div>
                    ...
                    <table class="table table-hover">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3 text-uppercase small">Category name</th>
                            ...
                            @foreach ($category as $item)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 d-flex gap-2">
                                        <a href="{{ route('category.edit', $item->id) }}" class="btn text-light bg-warning">Edit</a>
