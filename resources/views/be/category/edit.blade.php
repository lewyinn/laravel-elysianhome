    ...
    <div class="container-fluid">
        ...
        <div class="card shadow">
            ...
            <div class="card-body p-4">
                <form action="{{ route('category.update', $category->id) }}" id="formEditCategory" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                            value="{{ old('name', $category->name) }}" placeholder="Enter Name of Category" required>
                    </div>
                    ...
                    <button type="button" id="btnSimpan" class="btn btn-primary">Update</button>
                </form>
            </div>
        </div>
    </div>
